 ...
 * accepts a list of comma-separated bookCategory names.
 *
 ...
 * tracing.enable();  // Enable trace event capture for the 'node.perf' bookCategory
 *
 * // do work
 *
 * tracing.disable();  // Disable trace event capture for the 'node.perf' bookCategory
 * ```
 *
...
declare module "trace_events" {
    ...
    interface Tracing {
         ...
         *
         * t2.disable(); // Will only disable emission of the 'node.perf' bookCategory
         *
         * // Prints 'node,v8'
         * console.log(trace_events.getEnabledCategories());
         * ```
    ...
    interface CreateTracingOptions {
        /**
         * An array of trace bookCategory names. Values included in the array are
